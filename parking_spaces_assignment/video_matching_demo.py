...
if __name__ == '__main__':
    ...
    matcher = Matcher(active_cams=cam_list, parking_ground=args.parking_ground, model_arch=args.model_arch, checkpoint_name=args.checkpoint_name, detection_vehicle_thresh=args.detection_vehicle_thresh)
    matcher.video_match(video_source_list=video_source_list, is_savevideo=True, save_dir=args.video_output_dir,
                        cam_list=cam_list, ios_threshold=args.ios_threshold, iov_threshold=args.iov_threshold, is_tracking=True, is_showframe=args.is_showframe)
