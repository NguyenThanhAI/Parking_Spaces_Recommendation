...
if __name__ == '__main__':
    args = get_args()
    matcher = Matcher(active_cams=[args.cam_list], parking_ground=args.parking_ground, model_arch=args.model_arch, checkpoint_name=args.checkpoint_name, detection_vehicle_thresh=args.detection_vehicle_thresh)
