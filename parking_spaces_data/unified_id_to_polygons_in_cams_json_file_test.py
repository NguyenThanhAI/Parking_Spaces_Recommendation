    ...
    for parking_ground in unified_id_to_polygons:
        ...
        for cam in cam_list:
            ...
            for unified_id in unified_id_to_polygons[parking_ground]:
                if cam in unified_id_to_polygons[parking_ground][unified_id]["positions"]:
                    segment = unified_id_to_polygons[parking_ground][unified_id]["positions"][cam]
